  ...
  return (
    <Section className={styles.section}>
      ...
      <div className={styles.logoContainer}>
        ...
        Dengan segala kerendahan hati, kami menyampaikan permohonan maaf apabila Bapak/Ibu/Saudara/i belum dapat kami undang pada acara ini. Hal tersebut dikarenakan keterbatasan tempat dan kondisi yang tidak memungkinkan kami untuk mengundang seluruh kerabat dan sahabat.
        </p>
